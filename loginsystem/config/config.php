...
define("COOKIE_DOMAIN", ".107.170.185.83");
define("COOKIE_SECRET_KEY", "09jr<>98eh8U!#R^%D8&f6%D6SDFop^f");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://107.170.185.83/login/password_reset.php");
 ...
 */
define("EMAIL_VERIFICATION_URL", "http://107.170.185.83/login/register.php");
